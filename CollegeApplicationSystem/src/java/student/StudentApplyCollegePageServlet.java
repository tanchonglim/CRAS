 ...
 * @author USER
 */
@WebServlet(name = "StudentApplyCollegePageServlet", urlPatterns = {"/StudentApplyCollegePageServlet"})
public class StudentApplyCollegePageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           RequestDispatcher rd = request.getRequestDispatcher("/studentApplyCollege.jsp");
           rd.forward(request, response); 
           
           response.sendRedirect(request.getContextPath() + "/studentApplyCollege.jsp");
