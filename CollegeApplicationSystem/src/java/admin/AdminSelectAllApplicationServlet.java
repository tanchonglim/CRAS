 ...
 * @author
 */
@WebServlet(name = "AdminSelectAllApplicationServlet", urlPatterns = {"/AdminSelectAllApplicationServlet"})
public class AdminSelectAllApplicationServlet extends HttpServlet {
    ...
    public void init() throws ServletException
    {
        ...
        jdbcUtility.prepareSQLStatementSelectAllApplication();
    }     
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            PreparedStatement ps = jdbcUtility.getPsSelectAllApplication();
            ...
            request.getRequestDispatcher("adminViewApplication.jsp").forward(request, response);
