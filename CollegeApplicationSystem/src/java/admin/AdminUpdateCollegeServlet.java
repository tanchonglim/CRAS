 ...
 * @author Ong Shi Bing
 */
@WebServlet(name = "AdminUpdateCollegeServlet", urlPatterns = {"/AdminUpdateCollegeServlet"})
public class AdminUpdateCollegeServlet extends HttpServlet {
    ...
    public void init() throws ServletException
    {
        ...
        jdbcUtility.prepareSQLStatementUpdateCollege();
    }     
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       //get data from form
        ...
        try {
            PreparedStatement ps = jdbcUtility.getpsUpdateCollege();
